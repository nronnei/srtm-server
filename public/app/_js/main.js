...
var dem = L.tileLayer('http://ashtonjpm.geo.msu.edu/dem/{z}/{x}/{y}/dem.png', {attribution: srtmAttr});
var hillshade = L.tileLayer('http://ashtonjpm.geo.msu.edu/hillshade/{z}/{x}/{y}/shade.png', {attribution: srtmAttr});
var slope = L.tileLayer('http://ashtonjpm.geo.msu.edu/slope/{z}/{x}/{y}/slope.png', {attribution: srtmAttr});
// SRTM error layers
var errAttr = ' | Error Simulation by A. Shortridge & J. Messina';
var sim1 = L.tileLayer('http://ashtonjpm.geo.msu.edu/sim1/{z}/{x}/{y}/sim1.png', {attribution: errAttr});
var sim2 = L.tileLayer('http://ashtonjpm.geo.msu.edu/sim2/{z}/{x}/{y}/sim2.png', {attribution: errAttr});
var sim3 = L.tileLayer('http://ashtonjpm.geo.msu.edu/sim3/{z}/{x}/{y}/sim3.png', {attribution: errAttr});
